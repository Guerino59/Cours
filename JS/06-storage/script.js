...
const bT = document.querySelector(".blueTheme");
const rT = document.querySelector(".redTheme");
const gT = document.querySelector(".greenTheme");

bT.addEventListener("click", changeBlue);
rT.addEventListener("click", changeRed);
gT.addEventListener("click", changeGreen);

function changeBlue() {
  document.body.classList.remove("green", "red");
  document.body.classList.toggle("blue");
  localStorage.setItem("them", "blue");
}

function changeRed() {
  document.body.classList.remove("green", "blue");
  document.body.classList.toggle("red");
  localStorage.setItem("them", "red");
}

function changeGreen() {
  document.body.classList.remove("blue", "red");
  document.body.classList.toggle("green");
  localStorage.setItem("them", "green");
}