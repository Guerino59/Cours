...
<form action="" method="post">
    ...
    <input type="text" name="username" id="username" <?php echo $required ?? ""?> value="<?php echo $user['username']??""?>">
    <span class="error"><?php echo $error["username"]??"" ?></span>
    <br>
    <!-- Email -->
    <label for="email">Adresse Email :</label>
    <input type="email" name="email" id="email" <?php echo $required ?? ""?> value="<?php echo $user['email']??""?>">
